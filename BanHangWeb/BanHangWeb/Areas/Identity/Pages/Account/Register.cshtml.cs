    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Email đã được đăng ký tài khoản.");
                    return Page();
                }
                ...
                if (result.Succeeded)
                {
                    ...
                    // 👉 KHÔNG ĐI QUA RegisterConfirmation NỮA
                    // Tự động đăng nhập rồi quay về returnUrl (mặc định là "/")
